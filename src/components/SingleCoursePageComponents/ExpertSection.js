      ...
      <div className="expert-section">
        ...
        <div className="expert-section__bottom">
          ...
          <div className="expert-section__bottom--right">
            ...
            <h2>
              <span style={{ backgroundColor: "#FF7171" }}></span>Senior level
              mentor
            </h2>
            <h2>
              <span style={{ backgroundColor: "#FFA724" }}></span>Highest rating
              in Music
            </h2>
            <h2>
              <span style={{ backgroundColor: "#000072" }}></span>6+ Years of
              experience
            </h2>
          </div>
        </div>
